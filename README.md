...
The visual style is **Modernist**: flat and architectural, set in Archivo, a single red
accent (`#ec3013`) on a light ground, a visible modular grid, zero corner radius, and strong
2px rules. Design tokens live at the top of `styles.css` — restyling is a matter of editing
those variables.
